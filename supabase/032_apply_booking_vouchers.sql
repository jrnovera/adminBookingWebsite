-- Re-issued copy of 008_booking_vouchers.sql: that file already existed in
-- this repo but was confirmed (via a live schema audit against the Supabase
-- REST API) to have never actually been applied to the database — calling
-- validate_voucher() returns PGRST202 "function not found". Content is
-- byte-identical to 008; this just gives it a fresh, obviously-unapplied
-- migration number so it doesn't get skipped again as "already done".
--
